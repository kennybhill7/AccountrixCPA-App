...
export default function StatePage() {
  ...
  function exportState() {
    ...
    a.href = url; a.download = 'accountrix-state.json'; document.body.appendChild(a); a.click(); a.remove();
    ...
    <div className="container mx-auto px-4 py-10">
      <Card>
        ...
        <CardContent className="flex gap-3 items-center">
          <Button onClick={exportState} className="btn-primary">Export JSON</Button>
