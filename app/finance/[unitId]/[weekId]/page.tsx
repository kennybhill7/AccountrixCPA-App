...
export default function FinanceWeekPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex min-w-0 items-center gap-4">
            ...
            <div className="min-w-0">
              <h1 className="truncate font-display tracking-tight font-semibold">{week.title}</h1>
      ...
      <div>
        <h2 className="mb-1 text-xl font-display tracking-tight font-semibold">Drill generator</h2>
      ...
      <GlassCard className="flex items-center justify-between gap-4 rounded-2xl p-5">
