...
const SCENARIOS: Scenario[] = [
  {
    ...
    trialBalance: [
      ...
      { code: '1510', name: 'Accumulated Depreciation - Equipment', debit: 0, credit: 40000, type: 'asset' },
    ...
    tasks: [
      {
        ...
        type: 'review',
        scenario: {
          instruction: 'Review the trial balance and confirm it balances before making adjustments.',
        },
        instruction: 'Verify that total debits equal total credits in the unadjusted trial balance.',
        solution: {
          answer: 'balanced',
        },
        points: 5,
        ...
        explanation: 'Always verify the trial balance is mathematically correct before making adjustments.',
      },
      {
        id: 'depreciation',
        ...
        instruction: 'Equipment was purchased at the beginning of the year. Calculate and record monthly depreciation using the straight-line method.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'A 6-month insurance policy was purchased on September 1 for $6,000. Record the insurance expense for November.',
        solution: {
        ...
        explanation: 'Prepaid expenses must be adjusted each period to match expenses with the period benefited.',
      },
      {
        id: 'accrue-payroll',
        ...
        instruction: 'Employees are paid bi-weekly. The last pay date was November 26. Accrue payroll expense for the last 4 days of November at $800 per day.',
        solution: {
        ...
        explanation: 'Accrued payroll ensures expenses are recorded in the period they are incurred, not when paid.',
      },
      {
        id: 'unearned-revenue',
        ...
        instruction: 'The company received $12,000 in advance for services. During November, $3,000 of services were performed. Record the adjustment.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Prepaid rent of $9,000 covers October, November, and December. Record the rent expense for November.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Calculate net income after all adjusting entries. Use the formula: Total Revenues - Total Expenses.',
        solution: {
        ...
        explanation: 'Net income is the difference between total revenues and total expenses for the period.',
      },
      {
        id: 'verify-balance',
        ...
        type: 'review',
        scenario: {
          instruction: 'Confirm that the adjusted trial balance still balances after all adjustments.',
        },
      ...
      },
      {
        ...
        instruction: 'Perform a final review of all work and confirm the month-end close is complete.',
        solution: {
          answer: 'complete',
        },
        points: 6,
  ...
  },
  {
    ...
    trialBalance: [
      ...
      { code: '1025', name: 'Allowance for Doubtful Accounts', debit: 0, credit: 3000, type: 'asset' },
      ...
      { code: '1510', name: 'Accumulated Depreciation - Equipment', debit: 0, credit: 80000, type: 'asset' },
      { code: '1600', name: 'Building', debit: 500000, credit: 0, type: 'asset' },
      { code: '1610', name: 'Accumulated Depreciation - Building', debit: 0, credit: 100000, type: 'asset' },
      ...
      { code: '5040', name: 'Insurance Expense', debit: 0, credit: 0, type: 'expense' },
      { code: '5050', name: 'Depreciation Expense - Equipment', debit: 0, credit: 0, type: 'expense' },
      { code: '5060', name: 'Depreciation Expense - Building', debit: 0, credit: 0, type: 'expense' },
    ...
    tasks: [
      ...
      },
      {
        ...
        instruction: 'Calculate and record annual depreciation for equipment using straight-line method.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Calculate and record annual depreciation for the building using straight-line method.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'The company paid $12,000 for annual insurance on January 1. Record the full year\'s insurance expense.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Employees are paid bi-weekly. The last pay date was December 26. Accrue payroll for the last 5 working days of the year at $2,500 per day.',
        solution: {
        ...
        explanation: 'Year-end accrued payroll ensures all expenses are recorded in the correct year.',
      },
      {
        id: 'accrue-interest',
        ...
        instruction: 'Notes payable of $200,000 carry a 6% annual interest rate. Interest was last paid on October 1. Accrue interest for October, November, and December.',
        solution: {
        ...
        explanation: 'Interest expense must be accrued for the period it has been incurred but not paid.',
      },
      {
        id: 'bad-debt-expense',
        ...
        instruction: 'Estimate bad debts at 4% of accounts receivable. The current allowance balance is $3,000. Record the adjustment needed.',
        solution: {
        ...
        explanation: 'Bad debt expense is estimated based on accounts receivable and the allowance method.',
      },
      {
        ...
        scenario: {
          wipBalance: 95000,
          projectCompletion: 0.80,
          totalContractValue: 150000,
          revenueRecognizedToDate: 120000,
        },
        instruction: 'A construction project is 80% complete. Total contract value is $150,000. Revenue recognized to date is $120,000. Calculate additional revenue to recognize.',
        solution: {
          calculation: '$150,000 * 80% = $120,000 total revenue; Already recognized $120,000; No additional revenue',
          entries: [
      ...
      },
      {
        ...
        instruction: 'The company received $30,000 in customer deposits. During the year, $18,000 of services were completed. Record the earned revenue.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Close all revenue accounts to Retained Earnings. Total revenue (including adjustments) is $768,000.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Close all expense accounts to Retained Earnings. Total expenses (including adjustments) is $679,400.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Close the Dividends account to Retained Earnings. Dividends declared during the year were $50,000.',
        solution: {
        ...
        explanation: 'Closing dividends reduces Retained Earnings and closes the temporary account.',
      },
      {
        id: 'net-income-calc',
        title: 'Calculate Net Income',
  ...
  },
  {
    ...
    company: 'Summit Construction Co.',
    period: 'December 2024',
    description: 'Advanced construction company close with WIP, percentage of completion, and retention payables',
    timeLimit: 75,
    difficulty: 'advanced',
    trialBalance: [
      { code: '1010', name: 'Cash', debit: 145000, credit: 0, type: 'asset' },
      { code: '1020', name: 'Accounts Receivable', debit: 120000, credit: 0, type: 'asset' },
      { code: '1025', name: 'Allowance for Doubtful Accounts', debit: 0, credit: 4000, type: 'asset' },
      ...
      { code: '1050', name: 'Work in Progress - Project A', debit: 125000, credit: 0, type: 'asset' },
      { code: '1051', name: 'Work in Progress - Project B', debit: 85000, credit: 0, type: 'asset' },
      { code: '1052', name: 'Work in Progress - Project C', debit: 45000, credit: 0, type: 'asset' },
      ...
      { code: '1510', name: 'Accumulated Depreciation - Equipment', debit: 0, credit: 135000, type: 'asset' },
      { code: '1600', name: 'Vehicles', debit: 180000, credit: 0, type: 'asset' },
      { code: '1610', name: 'Accumulated Depreciation - Vehicles', debit: 0, credit: 54000, type: 'asset' },
      ...
      { code: '2500', name: 'Notes Payable - Equipment', debit: 0, credit: 180000, type: 'liability' },
      ...
      { code: '5050', name: 'Salaries - Administrative', debit: 125000, credit: 0, type: 'expense' },
      { code: '5060', name: 'Insurance Expense', debit: 0, credit: 0, type: 'expense' },
      { code: '5070', name: 'Depreciation Expense - Equipment', debit: 0, credit: 0, type: 'expense' },
      { code: '5080', name: 'Depreciation Expense - Vehicles', debit: 0, credit: 0, type: 'expense' },
    ...
    tasks: [
      ...
      },
      {
        ...
        instruction: 'Calculate annual depreciation for construction equipment using straight-line method.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Calculate annual depreciation for company vehicles using straight-line method.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Record the full year\'s insurance expense. The annual policy expires December 31.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Notes payable for equipment is $180,000 at 5% annual interest. Interest was last paid September 30. Accrue interest for Q4.',
        solution: {
        ...
        explanation: 'Interest expense accrues over time and must be recorded in the period incurred.',
      },
      {
        ...
        instruction: 'The line of credit balance is $75,000 with 7% annual interest. Accrue December interest.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Estimate bad debts at 3% of total receivables (A/R + Retention). Current allowance is $4,000. Record the adjustment.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Estimate warranty expense at 2% of total revenue. Current warranty liability is $15,000. Calculate the adjustment needed.',
        solution: {
      ...
      },
      {
        ...
        instruction: 'Project A is 90% complete with a contract value of $200,000. Revenue recognized to date is $160,000. Record additional revenue.',
        solution: {
          calculation: '$200,000 * 90% = $180,000 total; Already recognized $160,000; Additional $20,000',
          entries: [
      ...
      },
      {
        ...
        instruction: 'Project B is 70% complete with a contract value of $180,000. Revenue recognized to date is $108,000. Record additional revenue.',
        solution: {
          calculation: '$180,000 * 70% = $126,000 total; Already recognized $108,000; Additional $18,000',
          entries: [
      ...
      },
      {
        ...
        scenario: {
          ...
          percentComplete: 0.40,
          costsIncurred: 45000,
          revenueRecognizedToDate: 45000,
        },
        instruction: 'Project C is 40% complete with a contract value of $150,000. Revenue recognized to date is $45,000. Record additional revenue.',
        solution: {
          calculation: '$150,000 * 40% = $60,000 total; Already recognized $45,000; Additional $15,000',
          entries: [
      ...
      },
      {
        ...
        instruction: 'Customer deposits total $40,000. During the year, $25,000 of services were performed. Recognize the earned revenue.',
        solution: {
  ...
  const validateJournalEntry = (
    ...
    for (let i = 0; i < solution.length; i++) {
      ...
      if (actual.account !== expected.account) {
        errors.push(`Entry ${i + 1}: Expected account "${expected.account}", got "${actual.account || 'none'}"`);
      ...
      if (debitDiff > tolerance) {
        ...
        if (percentOff > 0.1) {
          errors.push(`Entry ${i + 1}: Debit amount significantly off (expected ${expected.debit}, got ${actual.debit || 0})`);
          deductions += task.points * 0.5; // 50% penalty if off by >10%
        } else {
          errors.push(`Entry ${i + 1}: Debit amount slightly off (expected ${expected.debit}, got ${actual.debit || 0})`);
      ...
      if (creditDiff > tolerance) {
        ...
        if (percentOff > 0.1) {
          errors.push(`Entry ${i + 1}: Credit amount significantly off (expected ${expected.credit}, got ${actual.credit || 0})`);
          deductions += task.points * 0.5;
        } else {
          errors.push(`Entry ${i + 1}: Credit amount slightly off (expected ${expected.credit}, got ${actual.credit || 0})`);
          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center p-6 bg-primary/5 rounded-lg">
              ...
              <div className="text-muted-foreground">
                Time Taken: {formatTime(score.timeTaken)}
              </div>
            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-sm">
                        {attempt ? (
                          <span className={attempt.isCorrect ? 'text-green-600' : 'text-yellow-600'}>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              {/* Feedback */}
              {taskFeedback && (
                <Alert className={taskFeedback.includes('Correct') ? 'border-green-600' : 'border-yellow-600'}>
